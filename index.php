...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="70">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top d-flex">
    <div class="container">
      <a class="navbar-brand" href="#"><span class="dot">Donaciones</span></a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav"
        aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <a href="./Form/RegistroUsuario/registroUser.php"
    ...
    <div class="slide slide1">
      <div class="container">
        <div class="row">
          ...
          <h1 class="display-3 my-4">Transforma vidas con<br />tu generosidad</h1>
          </div>
        </div>
      </div>
    </div>
    <div class="slide slide2">
      <div class="container">
        <div class="row">
          ...
          <h1 class="display-3 my-4">Cada donación<br />hace la diferencia</h1>
          </div>
        </div>
      </div>
    </div>
